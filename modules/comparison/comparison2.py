...
def highlightedBlocks(index1, index2, file1, file2, file1Stripped, file2Stripped):
    """
    ...
    ii1 = invertIndex(file1MatchedHashes)
    ii2 = invertIndex(file2MatchedHashes)    

    # do the same for original indices
    oi1 = invertIndex(index1)
    oi2 = invertIndex(index2)   
...
#highlightedBlocks(index1, index2, "databaseFile2.py", "databaseFile3.py",  "databaseFile2.py_Stripped", "databaseFile3.py_Stripped")