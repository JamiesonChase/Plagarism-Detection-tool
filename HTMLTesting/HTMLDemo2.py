...
def printFiles(file1, list1):
    returnString = "File1 source code:<br>"
    ...
    for line in lines:
        if i in list1:
            ...
            returnString = returnString + '<p style="color:blue;">' + line + "</p><br>"
            print(Style.RESET_ALL,end="")
        else:
            print(line,end="")
            returnString = returnString + '<p style="color:black;">' + line + "</p><br>"
        i = i + 1
    print(Style.RESET_ALL,end="")
    f1.close()
    return returnString
...
def main():
    ...
    firstFile = translate_print("doc2", masterlist, inputFile)
